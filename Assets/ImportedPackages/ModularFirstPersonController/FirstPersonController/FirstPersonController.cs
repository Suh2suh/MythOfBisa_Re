...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        fpc.camMover = (MainCamMoving)EditorGUILayout.ObjectField(new GUIContent("CamMover", "Main Cam Moving Object"), fpc.camMover, typeof(MainCamMoving), true);
        ...
        fpc.walkSpeed = EditorGUILayout.Slider(new GUIContent("Walk Speed", "Determines how fast the player will move while walking."), fpc.walkSpeed, .1f, 15f);
        GUI.enabled = true;
